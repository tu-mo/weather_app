...
<View style={{flexDirection: 'row'}}>

    {
        ...
        data.map((data, idx) => (
            ...
            idx < 24 && <FutureDailyItem forecastItem={data} index={(hour+idx+1) < 24 ? (hour+idx+1) : ((hour+idx+1) - 24) } />
...
const FutureDailyItem = ({index, forecastItem}) => {
...
<View  style={styles.futureForecastItemContainer}>
    ...
    <Image source={img} style={styles.image} />
    {/* <Text  style={styles.temp}>Night - {forecastItem.temp.night}&#176;C</Text> */}
    <Text  style={styles.temp}>{index < 10 ? '0' + index : index} - {forecastItem.temp}&#176;C</Text>

</View>
)
}

export {FutureForecast, FutureDaily}
